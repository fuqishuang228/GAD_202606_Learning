...
parser.add_argument('--target_datasets', type=str, default='dnc_10percent',
                    help='Target dataset name to adapt and test on')
...
parser.add_argument('--no_rel', type=float, default=0.1)
parser.add_argument('--relevance', type=float, default=0.1)
parser.add_argument('--difference', type=float, default=0.9)  
parser.add_argument('--confident', type=float, default=0.1)  
parser.add_argument('--confident_detection_method', type=str, default='random',
...
parser.add_argument('--pretrained_model_path', type=str,
                    default='./save_model/Wikipedia_MOOC_best_model.pt')
parser.add_argument('--save_dir', type=str, default='./save_model')
parser.add_argument('--results_dir', type=str, default='./results')
parser.add_argument('--representation_dir', type=str, default='./representation')
